...
Основная связующая сущность - MainProtocol: основные данные из протокола - 4 колонки.
...
class ProdControl(Base):
    ...
    # violat_main = Column(Boolean)  # Основные числа.
    # violat_dev = Column(Boolean)  # Числа с отклонением.
