...
EXPECTED_FROM_PARSER = {(0, 'MAIN'): {
    'Заявитель и его адрес (юридический и фактический)': 'АО «ДИКСИ ЮГ», ИНН: 5036045205, '
                                                         'МО, г. Подольск, '
                                                         'ул. Юбилейная, д. 32 А;'
                                                         '\nЛенинградская область, '
                                                         'Гатчинский р-н, г. Гатчина, ул. Куприна, '
                                                         'д. 48, л. А (№ 47109)',
    ...
    (1, 'manuf_prod'): {'Шифр пробы': '4225-1', 'Группа продукции': 'Продукция производителя',
                        ...
                        'Цель исследования': 'Производственный контроль. '
                                             ...
                                             ' утв. '
                                             'Решением КТС от 9 декабря 2011 года№ 880',
                        'Сведения о СИ': 'Генератор концентрации биодоз Delta Dilutor Standard, '
                                         '(39629-08), 10002510S/448; '
                                         'анализатор жидкости "Эксперт-001" '
                                         '№ 7106; pH-метр и иономер -150МИ №8297',
                        'Дата проведения исследований': '02.05.2024 г.- 13.05.2024 г.',
                        'indicators': [{
                            'Внешний вид тары после гермостатирования. '
                            ...
                            'Спорообразующие мезофильные аэробные и факультативно-анаэробные '
                            'микроорганизмы группыВ. cereus и B.polymyxa': {
                            ...
                            'аэробные и факультативно-анаэробные микроорганизмы': {
                                'result': 'не обнаружено в 1 г (см³)',
                                'norm': 'не допускаются в 1 г (см³) при температуре '
                                        'хранения выше 20°С',
                                'norm_doc': 'ГОСТ 30425-97',
                                'conformity_main': True},
    ...
    (3, 'manuf_prod'): {'Шифр пробы': '4225-2', 'Группа продукции': 'Продукция производителя',
                        ...
                        'Цель исследования': 'Производственный контроль. '
                                             ...
                                             ' «О безопасности '
                                             'пищевой продукции», утв. Решением КТС '
                                             'от 9 декабря 2011 '
                                             'года№ 880. На соответствие требованиям '
                                             'ТР ЕАЭС 040/2016 '
                                             '«0 безопасности рыбы и рыбной продукции»,'
                                             ' утв. Решением '
                                             'Совета ЕЭК от 18 октября 2016 года№ 162',
                        'Сведения о СИ': 'Анализатор микробиологический «БакТрак- 4300, 24961-03, '
                                         '№ S4310V15HEO6; генератор концентрации биодоз'
                                         ' Delta Dilutor '
                                         'Standard, (39629-08), 10002510S/448; '
                                         'анализатор жидкости '
                                         '"Эксперт-001" № 7106',
    ...
    (5, 'manuf_prod'): {'Шифр пробы': '4225-3', 'Группа продукции': 'Продукция производителя',
                        'Наименование продукции': 'Масло сладко-сливочное '
                                                  'несоленое м.д. жира 82,5 %',
                        ...
                        'Цель исследования': 'Производственный контроль. '
                                             'На соответствие требованиям '
                                             'ТР ТС 021/2011 «О безопасности пищевой продукции», '
                                             'утв. Решением КТС от 9 декабря 2011 года № 880. На '
                                             'соответствие требованиям ТР ТС '
                                             '033/2013 «О безопасности '
                                             'молока и молочной продукции», утв. '
                                             'Решением Совета ЕЭК '
                                             'от 9 октября 2013 года№ 67 приложение 8. МУ 4.1 '
                                             './4.2.2484-09, ГОСТ Р 52253-04',
                        'Сведения о СИ': 'Весы лабораторные электронные AF-R220CE № 086550117; '
                                         'хроматограф газовый «Хроматэк-Кристалл 5000.2»'
                                         ' /ЭЗД/ТИД № 552363; '
                                         'генератор концентрации биодоз Delta Dilutor'
                                         ' Standard, (39629-08), '
                                         '1000251OS/448; анализатор жидкости "Эксперт- 001" №7106',
                        'Дата проведения исследований': '02.05.2024 г.-08.05.2024 г.',
    ...
    (8, 'manuf_prod'): {'Шифр пробы': '4225-4', 'Группа продукции': 'Продукция производителя',
                        ...
                        'Цель исследования': 'Производственный контроль. '
                                             'На соответствие требованиям '
                                             'ТР ЕАЭС 051/2021 «О безопасности мяса '
                                             'птицы и продукции '
                                             'его переработки», утв. Решением Совета '
                                             'ЕЭК от 29 октября '
                                             '2021 года№110 На соответствие требованиям '
                                             'ТР ТС 021/2011 '
                                             '«О безопасности пищевой продукции», '
                                             'утв. Решением КТС от '
                                             '9 декабря 2011 года № 880',
                        'Сведения о СИ': 'Генератор концентрации биодоз Delta Dilutor Standard, '
                                         '(39629-08), 10002510S/448; анализатор жидкости '
                                         '"Эксперт-001" № 7106',
                        'Дата проведения исследований': '02.05.2024 г. - 08.05.2024 г.',
                        'indicators': [{
                            'Количество мезофильных, аэробных и факультативно-анаэробных '
    ...
    (10, 'air'): {'Шифр пробы': '4225 - 5',
                  ...
                  'Сведения о СИ': 'Весы лабораторные JW-1, № 0509082; '
                                   'анализатор жидкости мод. Эксперт-001, №7106',
            ...
            'violations_of_norms': (
                False,
                False)}]},
    (13, 'PROD_CONTROL'): {'Отдел «Овощи/фрукты», рабочее место работника торгового зала(Па)': {
        'parameter': 'Относительная влажность воздухаОтносительная влажность воздуха', 'unit': '%',
        'result': '41,1±5,8', 'norm': '15-75', 'conformity_main': True,
        'conformity_deviation': True},
        ...
        'Торговый зал у холодильной витрины с молочной продукцией': {
            'parameter': 'Вибрация общаяZo', 'unit': 'ДБ', 'result': 'менее 70',
            'norm': '80', 'conformity_main': True},
        'violations_of_norms': (False, False)}}
