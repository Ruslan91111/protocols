data_for_main_collector = {
    ...
    'data_from_tables': {
        (0, 'MAIN'): {
            ...
            'Сопроводительные документы': 'Акт отбора проб № 4225 от 02.05.2024 г.',
        ...
        (1, 'manuf_prod'): {'Шифр пробы': '4225-1', 'Группа продукции': 'Продукция производителя',
                            ...
                            'Дата проведения исследований': '02.05.2024 г.- 13.05.2024 г.', 'indicators': [{
        ...
        (3, 'manuf_prod'): {'Шифр пробы': '4225-2', 'Группа продукции': 'Продукция производителя',
                            'Наименование продукции': 'Салака х/к', 'НД на продукцию': 'ТУ 10.20.24-129-00472093-2017',
                            ...
                            'Дата проведения исследований': '02.05.2024 г.-08.05.2024 г.', 'indicators': [{
                'Количество мезофильных, аэробных и факультативно-анаэробных микроорганизмов, КОЕ/г': {
                    'result': '5,5х10²',
                    'norm': 'не более 3,0x10⁴',
                    'norm_doc': 'МУК 4.2.2578-2010',
                    'conformity_main': True},
                'БГКП (колиформы)': {
                    'result': 'не обнаружены в 0,1 г',
        ...
        (5, 'manuf_prod'): {'Шифр пробы': '4225-3', 'Группа продукции': 'Продукция производителя',
                            ...
                            'Дата проведения исследований': '02.05.2024 г.-08.05.2024 г.', 'indicators': [{
                'Массовая доля масляной кислоты (Сдд), %': {
                    'result': '3,2±0,4',
                    'norm': '2,0-4,2',
                    ...
                    'conformity_main': True}},
                {
                    'Количество мезофильных, аэробных и факультативно-анаэробных микроорганизмов, КОЕ/г': {
                        'result': '8,5х10³',
                        'norm': 'не более 1,0x10⁵',
                        'norm_doc': 'ГОСТ 32901-14',
                        'conformity_main': True},
                    'БГКП (колиформы)': {
                        'result': 'не обнаружено в 0,01 г',
        ...
        (8, 'manuf_prod'): {'Шифр пробы': '4225-4', 'Группа продукции': 'Продукция производителя',
                ...
                'БГКГ1 (колиформы)': {
                    ...
                    'norm': 'не допускаются в 0,0001 г',
                    'norm_doc': 'ГОСТ 31747-2012',
                    'conformity_main': True},
                'L. monocytogenes': {
                    'result': 'не обнаружено в 25 г',
                ...
                'Патогенные микроорганизмы, в т.ч. сальмонеллы': {
                    ...
                    'norm_doc': 'ГОСТ 31659-2012',
                    'conformity_main': True}}]},
        (10, 'air'): {'Шифр пробы': '4225 - 5', 'Объект исследования': 'Воздух (микробная обсемененность)',
                ...
                'Холодильная камера «Молочные продукты»': {
                    'name': 'Плесени,КОЕ на чашке',
                    'sampling_site': 'Холодильная камера «Молочные продукты»',
                    'result': '0',
                    'norm': '',
                    'norm_doc': 'СП 4695-88',
                    'conformity_main': True},
                'Холодильная камера «Молочные продукты»_0': {
                    'name': 'Плесени, КОЕ на чашке',
                    'sampling_site': 'Холодильная камера «Молочные продукты»',
                    'result': '0',
                    'norm': '-',
                               ...
                               'indicators': [{'Отдел «Овощи/фрукты», рабочее место работника торгового зала(Па)': {
                                   ...
                                   'conformity_main': True, 'conformity_deviation': True},
                                               ...
                                               'Торговый зал у холодильной витрины с молочной продукцией': {
                                                   'name': 'Шум Шум', 'unit': 'ДВА', 'result': '42,0±0,8', 'norm': '60',
