...
Конвертация фалов в папке из pdf в txt.
...
from constants import (FineReaderScreenshots, FINE_READER_PROCESS,
                       WORD_PROCESS, MESSAGE_FOR_USER_GET_DIR_WITH_PDF_FILES)
